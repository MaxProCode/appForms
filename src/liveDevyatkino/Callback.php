...
class Callback
{
    public static function add(array $data)
    {
        ...
        Телефон : $phone";
            ...
            Deal::addCommentInTimeline($idDeal, "Клиент повторно заполнил форму: 'Оставьте ваши контакты, и мы вам перезвоним live-devyatkino.ru/'" . $text);

            $params = [
                'TITLE' => 'Клиент повторно заполнил форму: Оставьте ваши контакты, и мы вам перезвоним live-devyatkino.ru/',
            ...
            if ($idContact) {
                $res = Deal::add([
                    'TITLE' => 'Оставьте ваши контакты, и мы вам перезвоним live-devyatkino.ru/',
