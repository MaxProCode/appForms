...
// Забронируйте место на экскурсию
...
class BookTicket
{
    public static function add(array $data)
    {
        ...
        // ищем контакт клиента по email или по телефону, если не находим, то создаем новые контакт и новую сделку
        ...
        Телефон : $phone";
            ...
            Deal::addCommentInTimeline($idDeal, "Клиент повторно заполнил форму: 'Забронируйте место на экскурсию live-devyatkino.ru/'" . $text);

            $params = [
                'TITLE' => 'Клиент повторно заполнил форму: Забронируйте место на экскурсию. live-devyatkino.ru/',
            ...
            if ($idContact) {
                $res = Deal::add([
                    'TITLE' => 'Забронируйте место на экскурсию. live-devyatkino.ru/',
