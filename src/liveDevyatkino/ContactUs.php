...
class ContactUs
{
    public static function add(array $data)
    {
        ...
        Телефон : $phone";
            ...
            Deal::addCommentInTimeline($idDeal, "Клиент повторно заполнил форму: 'Связаться с нами. https://live-devyatkino.ru/'" . $text);

            $params = [
                'TITLE' => 'Клиент повторно заполнил форму: Связаться с нами. https://live-devyatkino.ru/',
            ...
            if ($idContact) {
                $res = Deal::add([
                    'TITLE' => 'Связаться с нами. https://live-devyatkino.ru/',
